...
Database.streaks.bulkPut([
    { id: 1, name: "Streak 1", longestStreak: 0, currentStreak: 0, lastUpdated: new Date() },
    { id: 2, name: "Streak 2", longestStreak: 0, currentStreak: 0, lastUpdated: new Date() },
    { id: 3, name: "Streak 3", longestStreak: 0, currentStreak: 0, lastUpdated: new Date() },
    { id: 4, name: "Streak 4", longestStreak: 0, currentStreak: 0, lastUpdated: new Date() }
])
